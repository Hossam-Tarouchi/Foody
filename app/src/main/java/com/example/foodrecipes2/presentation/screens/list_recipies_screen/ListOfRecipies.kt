...
@Composable
fun ListOfRecipiesScreen(category: String?, navController: NavHostController) {

    val viewModel: RecipiesByCategoryViewModel = hiltViewModel()
    val state = viewModel.state.value

    LaunchedEffect(key1 = true) {
        category?.let { viewModel.getRecipiesByCategory(it) }
    }
